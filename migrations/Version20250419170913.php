 ...
 */
final class Version20250419170913 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        SQL);
        $this->addSql(<<<'SQL'
            CREATE TABLE comments (id SERIAL NOT NULL, user_id INT DEFAULT NULL, actuality_id INT DEFAULT NULL, comment TEXT NOT NULL, created_at TIMESTAMP(0) WITHOUT TIME ZONE NOT NULL, PRIMARY KEY(id))
        SQL);
        $this->addSql(<<<'SQL'
        ...
        SQL);
        $this->addSql(<<<'SQL'
            ALTER TABLE voting ADD actuality_id INT NOT NULL
        SQL);
        $this->addSql(<<<'SQL'
